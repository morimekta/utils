 ...
 * <p>Example:</p>
 * <p>
 * <code>String encoded = Base64.encodeToString( myByteArray );</code>
 * <br />
 * <code>byte[] myByteArray = Base64.decode( encoded );</code>
 * <p>
 * <p>The <tt>options</tt> parameter, which appears in a few places, is used to pass
 * several pieces of information to the encoder. In the "higher level" methods such as
 * encodeToString( bytes, options ) the options parameter can be used to indicate such
 ...
 * <p>
 * <code>String encoded = Base64.encodeToString( mybytes, Base64.GZIP | Base64.DO_BREAK_LINES );</code>
 * <p>to compress the data before encoding it and then making the output have newline characters.</p>
 * <p>Also...</p>
 * <code>String encoded = Base64.encodeToString( crazyString.getBytes() );</code>
 * <p>
 * <p>
 * <p/>
 * Providence specific Changes:
 * <ul>
 * <li>Moved InputStream and OutputStream to separate Byte64*Stream classes.</li>
 * <li>Removed Serializable support.</li>
 * <li>Removed GZIP support.</li>
 * <li>Enabled URL_SAFE encoding without padding.</li>
 * <li>Reformatting.</li>
 * </ul>
 * <p>
 * <p>
