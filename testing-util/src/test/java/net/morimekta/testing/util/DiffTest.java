 ...
 */
package net.morimekta.testing.util;

import net.morimekta.testing.util.Diff.Change;
import net.morimekta.testing.util.Diff.LinesToCharsResult;
...
import static net.morimekta.testing.util.Diff.Options.defaults;
...
public class DiffTest {
    ...
    public void testDiffHalfmatch() {
        // Detect a halfmatch.
        assertNull("halfMatch: No match #1.", dmp.halfMatch("1234567890", "abcdef"));

        assertNull("halfMatch: No match #2.", dmp.halfMatch("12345", "23"));
        ...
        dmp = new Diff("", "", defaults().withTimeout(0));
        assertNull("halfMatch: Optimal no halfmatch.", dmp.halfMatch("qHilloHelloHew", "xHelloHeHulloy"));
    }
    ...
    public void testDiffCharsToLines() {
        ...
        assertTrue("charsToLines: Equality #1.", new Change(EQUAL, "a").equals(new Change(EQUAL, "a")));

        assertEquals("charsToLines: Equality #2.", new Change(EQUAL, "a"), new Change(EQUAL, "a"));
        ...
        assertEquals("charsToLines: Shared lines.", diffList(new Change(EQUAL, "alpha\nbeta\nalpha\n"), new Change(INSERT, "beta\nalpha\nbeta\n")), diffs);
        ...
        dmp.charsToLines(diffs, tmpVector);
        assertEquals("charsToLines: More than 256.", diffList(new Change(DELETE, lines)), diffs);
    }
    ...
    public void testDiffCleanupMerge() {
        ...
        assertEquals("cleanupMerge: Null case.", diffList(), diffs);

        diffs = diffList(new Change(EQUAL, "a"), new Change(DELETE, "b"), new Change(INSERT, "c"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: No change case.", diffList(new Change(EQUAL, "a"), new Change(DELETE, "b"), new Change(INSERT, "c")), diffs);

        diffs = diffList(new Change(EQUAL, "a"), new Change(EQUAL, "b"), new Change(EQUAL, "c"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Merge equalities.", diffList(new Change(EQUAL, "abc")), diffs);

        diffs = diffList(new Change(DELETE, "a"), new Change(DELETE, "b"), new Change(DELETE, "c"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Merge deletions.", diffList(new Change(DELETE, "abc")), diffs);

        diffs = diffList(new Change(INSERT, "a"), new Change(INSERT, "b"), new Change(INSERT, "c"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Merge insertions.", diffList(new Change(INSERT, "abc")), diffs);
        ...
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Merge interweave.", diffList(new Change(DELETE, "ac"), new Change(INSERT, "bd"), new Change(EQUAL, "ef")), diffs);

        diffs = diffList(new Change(DELETE, "a"), new Change(INSERT, "abc"), new Change(DELETE, "dc"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Prefix and suffix detection.", diffList(new Change(EQUAL, "a"), new Change(DELETE, "d"), new Change(INSERT, "b"), new Change(EQUAL, "c")), diffs);

        diffs = diffList(new Change(EQUAL, "x"), new Change(DELETE, "a"), new Change(INSERT, "abc"), new Change(DELETE, "dc"), new Change(EQUAL, "y"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Prefix and suffix detection with equalities.", diffList(new Change(EQUAL, "xa"), new Change(DELETE, "d"), new Change(INSERT, "b"), new Change(EQUAL, "cy")), diffs);

        diffs = diffList(new Change(EQUAL, "a"), new Change(INSERT, "ba"), new Change(EQUAL, "c"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Slide edit left.", diffList(new Change(INSERT, "ab"), new Change(EQUAL, "ac")), diffs);

        diffs = diffList(new Change(EQUAL, "c"), new Change(INSERT, "ab"), new Change(EQUAL, "a"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Slide edit right.", diffList(new Change(EQUAL, "ca"), new Change(INSERT, "ba")), diffs);

        diffs = diffList(new Change(EQUAL, "a"), new Change(DELETE, "b"), new Change(EQUAL, "c"), new Change(DELETE, "ac"), new Change(EQUAL, "x"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Slide edit left recursive.", diffList(new Change(DELETE, "abc"), new Change(EQUAL, "acx")), diffs);

        diffs = diffList(new Change(EQUAL, "x"), new Change(DELETE, "ca"), new Change(EQUAL, "c"), new Change(DELETE, "b"), new Change(EQUAL, "a"));
        dmp.cleanupMerge(diffs);
        assertEquals("cleanupMerge: Slide edit right recursive.", diffList(new Change(EQUAL, "xca"), new Change(DELETE, "cba")), diffs);
    }
    ...
    public void testDiffCleanupSemanticLossless() {
        ...
        assertEquals("cleanupSemanticLossless: Null case.", diffList(), diffs);

        diffs = diffList(new Change(EQUAL, "AAA\r\n\r\nBBB"), new Change(INSERT, "\r\nDDD\r\n\r\nBBB"), new Change(EQUAL, "\r\nEEE"));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Blank lines.", diffList(new Change(EQUAL, "AAA\r\n\r\n"), new Change(INSERT, "BBB\r\nDDD\r\n\r\n"), new Change(EQUAL, "BBB\r\nEEE")), diffs);

        diffs = diffList(new Change(EQUAL, "AAA\r\nBBB"), new Change(INSERT, " DDD\r\nBBB"), new Change(EQUAL, " EEE"));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Line boundaries.", diffList(new Change(EQUAL, "AAA\r\n"), new Change(INSERT, "BBB DDD\r\n"), new Change(EQUAL, "BBB EEE")), diffs);

        diffs = diffList(new Change(EQUAL, "The c"), new Change(INSERT, "ow and the c"), new Change(EQUAL, "at."));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Word boundaries.", diffList(new Change(EQUAL, "The "), new Change(INSERT, "cow and the "), new Change(EQUAL, "cat.")), diffs);

        diffs = diffList(new Change(EQUAL, "The-c"), new Change(INSERT, "ow-and-the-c"), new Change(EQUAL, "at."));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Alphanumeric boundaries.", diffList(new Change(EQUAL, "The-"), new Change(INSERT, "cow-and-the-"), new Change(EQUAL, "cat.")), diffs);

        diffs = diffList(new Change(EQUAL, "a"), new Change(DELETE, "a"), new Change(EQUAL, "ax"));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Hitting the start.", diffList(new Change(DELETE, "a"), new Change(EQUAL, "aax")), diffs);

        diffs = diffList(new Change(EQUAL, "xa"), new Change(DELETE, "a"), new Change(EQUAL, "a"));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Hitting the end.", diffList(new Change(EQUAL, "xaa"), new Change(DELETE, "a")), diffs);

        diffs = diffList(new Change(EQUAL, "The xxx. The "), new Change(INSERT, "zzz. The "), new Change(EQUAL, "yyy."));
        dmp.cleanupSemanticLossless(diffs);
        assertEquals("cleanupSemanticLossless: Sentence boundaries.", diffList(new Change(EQUAL, "The xxx."), new Change(INSERT, " The zzz."), new Change(EQUAL, " The yyy.")), diffs);
    }
    ...
    public void testDiffCleanupSemantic() {
        ...
        assertEquals("cleanupSemantic: Null case.", diffList(), diffs);

        diffs = diffList(new Change(DELETE, "ab"), new Change(INSERT, "cd"), new Change(EQUAL, "12"), new Change(DELETE, "e"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: No elimination #1.", diffList(new Change(DELETE, "ab"), new Change(INSERT, "cd"), new Change(EQUAL, "12"), new Change(DELETE, "e")), diffs);

        diffs = diffList(new Change(DELETE, "abc"), new Change(INSERT, "ABC"), new Change(EQUAL, "1234"), new Change(DELETE, "wxyz"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: No elimination #2.", diffList(new Change(DELETE, "abc"), new Change(INSERT, "ABC"), new Change(EQUAL, "1234"), new Change(DELETE, "wxyz")), diffs);

        diffs = diffList(new Change(DELETE, "a"), new Change(EQUAL, "b"), new Change(DELETE, "c"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Simple elimination.", diffList(new Change(DELETE, "abc"), new Change(INSERT, "b")), diffs);

        diffs = diffList(new Change(DELETE, "ab"), new Change(EQUAL, "cd"), new Change(DELETE, "e"), new Change(EQUAL, "f"), new Change(INSERT, "g"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Backpass elimination.", diffList(new Change(DELETE, "abcdef"), new Change(INSERT, "cdfg")), diffs);
        ...
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Multiple elimination.", diffList(new Change(DELETE, "AB_AB"), new Change(INSERT, "1A2_1A2")), diffs);

        diffs = diffList(new Change(EQUAL, "The c"), new Change(DELETE, "ow and the c"), new Change(EQUAL, "at."));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Word boundaries.", diffList(new Change(EQUAL, "The "), new Change(DELETE, "cow and the "), new Change(EQUAL, "cat.")), diffs);

        diffs = diffList(new Change(DELETE, "abcxx"), new Change(INSERT, "xxdef"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: No overlap elimination.", diffList(new Change(DELETE, "abcxx"), new Change(INSERT, "xxdef")), diffs);

        diffs = diffList(new Change(DELETE, "abcxxx"), new Change(INSERT, "xxxdef"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Overlap elimination.", diffList(new Change(DELETE, "abc"), new Change(EQUAL, "xxx"), new Change(INSERT, "def")), diffs);

        diffs = diffList(new Change(DELETE, "xxxabc"), new Change(INSERT, "defxxx"));
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Reverse overlap elimination.", diffList(new Change(INSERT, "def"), new Change(EQUAL, "xxx"), new Change(DELETE, "abc")), diffs);
        ...
        dmp.cleanupSemantic(diffs);
        assertEquals("cleanupSemantic: Two overlap eliminations.", diffList(new Change(DELETE, "abcd"), new Change(EQUAL, "1212"), new Change(INSERT, "efghi"), new Change(EQUAL, "----"), new Change(DELETE, "A"), new Change(EQUAL, "3"), new Change(INSERT, "BC")), diffs);
    }
    ...
    public void testDiffCleanupEfficiency() {
        ...
        dmp.cleanupEfficiency(diffs);
        assertEquals("cleanupEfficiency: No elimination.", diffList(new Change(DELETE, "ab"), new Change(INSERT, "12"), new Change(EQUAL, "wxyz"), new Change(DELETE, "cd"), new Change(INSERT, "34")), diffs);

        diffs = diffList(new Change(DELETE, "ab"), new Change(INSERT, "12"), new Change(EQUAL, "xyz"), new Change(DELETE, "cd"), new Change(INSERT, "34"));
        dmp.cleanupEfficiency(diffs);
        assertEquals("cleanupEfficiency: Four-edit elimination.", diffList(new Change(DELETE, "abxyzcd"), new Change(INSERT, "12xyz34")), diffs);

        diffs = diffList(new Change(INSERT, "12"), new Change(EQUAL, "x"), new Change(DELETE, "cd"), new Change(INSERT, "34"));
        dmp.cleanupEfficiency(diffs);
        assertEquals("cleanupEfficiency: Three-edit elimination.", diffList(new Change(DELETE, "xcd"), new Change(INSERT, "12x34")), diffs);
        ...
        dmp.cleanupEfficiency(diffs);
        assertEquals("cleanupEfficiency: Backpass elimination.", diffList(new Change(DELETE, "abxyzcd"), new Change(INSERT, "12xy34z56")), diffs);

        dmp.getOptions().withEditCost( 5 );
        diffs = diffList(new Change(DELETE, "ab"), new Change(INSERT, "12"), new Change(EQUAL, "wxyz"), new Change(DELETE, "cd"), new Change(INSERT, "34"));
        dmp.cleanupEfficiency(diffs);
        assertEquals("cleanupEfficiency: High cost elimination.", diffList(new Change(DELETE, "abwxyzcd"), new Change(INSERT, "12wxyz34")), diffs);
    }
    ...
    public void testDiffPrettyHtml() {
        ...
        assertEquals("prettyHtml:", "<span>a&para;<br></span><del style=\"background:#ffe6e6;\">&lt;B&gt;b&lt;/B&gt;</del><ins style=\"background:#e6ffe6;\">c&amp;d</ins>", dmp.prettyHtml());
    }
    ...
    public void testDiffText() {
        ...
        assertEquals("text1:", "jumps over the lazy", dmp.text1());
        assertEquals("text2:", "jumped over a lazy", dmp.text2());
    }
    ...
    public void testDiffDelta() {
        ...
        assertEquals("text1: Base text.", "jumps over the lazy", text1);

        String delta = dmp.toDelta();
        assertEquals("toDelta:", "=4\t-1\t+ed\t=6\t-3\t+a\t=5\t+old dog", delta);

        // Convert delta string into a diff.
        assertEquals("fromDelta: Normal.", dmp, Diff.fromDelta(text1, delta));

        // Generates error (19 < 20).
        try {
            Diff.fromDelta(text1 + "x", delta);
            fail("fromDelta: Too long.");
        ...
        try {
            ...
            fail("fromDelta: Invalid character.");
        } catch (IllegalArgumentException ex) {
            // Exception expected.
        }
        ...
        text1 = dmp.text1();
        assertEquals("text1: Unicode text.", "\u0680 \000 \t %\u0681 \001 \n ^", text1);

        delta = dmp.toDelta();
        assertEquals("toDelta: Unicode.", "=7\t-7\t+%DA%82 %02 %5C %7C", delta);

        assertEquals("fromDelta: Unicode.", dmp, Diff.fromDelta(text1, delta));

        // Verify pool of unchanged characters.
        dmp = diff(new Change(INSERT, "A-Z a-z 0-9 - _ . ! ~ * ' ( ) ; / ? : @ & = + $ , # "));
        String text2 = dmp.text2();
        assertEquals("text2: Unchanged characters.", "A-Z a-z 0-9 - _ . ! ~ * \' ( ) ; / ? : @ & = + $ , # ", text2);

        delta = dmp.toDelta();
        assertEquals("toDelta: Unchanged characters.", "+A-Z a-z 0-9 - _ . ! ~ * \' ( ) ; / ? : @ & = + $ , # ", delta);

        // Convert delta string into a diff.
        assertEquals("fromDelta: Unchanged characters.", dmp, Diff.fromDelta("", delta));
    }
    ...
    public void testDiffBisect() {
        ...
        Diff diffs = diff(new Change(DELETE, "c"), new Change(INSERT, "m"), new Change(EQUAL, "a"), new Change(DELETE, "t"), new Change(INSERT, "p"));
        assertEquals("bisect: Normal.", diffs, new Diff(dmp.bisect(a, b), dmp.getOptions()));

        dmp.getOptions()
           .withTimeout(0.000000001);
        // timeout.
        diffs = new Diff(diffList(new Change(DELETE, "cat"), new Change(INSERT, "map")), dmp.getOptions(), 0);

        assertEquals("bisect: Timeout.", diffs, new Diff(diffs.bisect(a, b), dmp.getOptions(), 0));
    }

    @Test
    public void testDiffMain() {
        Diff.Options opts = defaults().withChangeLines(false);

        // Perform a trivial diff.
        Diff diffs = diff();
        assertEquals("main: Null case.", diffs, new Diff("", "", opts));

        diffs = diff(new Change(EQUAL, "abc"));
        assertEquals("main: Equality.", diffs, new Diff("abc", "abc", opts));

        diffs = diff(new Change(EQUAL, "ab"), new Change(INSERT, "123"), new Change(EQUAL, "c"));
        assertEquals("main: Simple insertion.", diffs, new Diff("abc", "ab123c", opts));

        diffs = diff(new Change(EQUAL, "a"), new Change(DELETE, "123"), new Change(EQUAL, "bc"));
        assertEquals("main: Simple deletion.", diffs, new Diff("a123bc", "abc", opts));

        diffs = diff(new Change(EQUAL, "a"), new Change(INSERT, "123"), new Change(EQUAL, "b"), new Change(INSERT, "456"), new Change(EQUAL, "c"));
        assertEquals("main: Two insertions.", diffs, new Diff("abc", "a123b456c", opts));

        diffs = diff(new Change(EQUAL, "a"), new Change(DELETE, "123"), new Change(EQUAL, "b"), new Change(DELETE, "456"), new Change(EQUAL, "c"));
        assertEquals("main: Two deletions.", diffs, new Diff("a123b456c", "abc", opts));

        // Perform a real diff.
        // Switch off the timeout.
        opts = opts.withTimeout(0);
        diffs = diff(new Change(DELETE, "a"), new Change(INSERT, "b"));
        assertEquals("main: Simple case #1.", diffs, new Diff("a", "b", opts));
        ...
        assertEquals("main: Simple case #2.", diffs, new Diff("Apples are a fruit.", "Bananas are also fruit.", opts));

        diffs = diff(new Change(DELETE, "a"), new Change(INSERT, "\u0680"), new Change(EQUAL, "x"), new Change(DELETE, "\t"), new Change(INSERT, "\000"));
        assertEquals("main: Simple case #3.", diffs, new Diff("ax\t", "\u0680x\000", opts));
        ...
        assertEquals("main: Overlap #1.", diffs, new Diff("1ayb2", "abxab", opts));

        diffs = diff(new Change(INSERT, "xaxcx"), new Change(EQUAL, "abc"), new Change(DELETE, "y"));
        assertEquals("main: Overlap #2.", diffs, new Diff("abcy", "xaxcxabc", opts));
        ...
        assertEquals("main: Overlap #3.", diffs, new Diff("ABCDa=bcd=efghijklmnopqrsEFGHIJKLMNOefg", "a-bcd-efghijklmnopqrs", opts));
        ...
        assertEquals("main: Large equality.", diffs, new Diff("a [[Pennsylvania]] and [[New", " and [[Pennsylvania]]", opts));
        ...
        assertTrue("main: Timeout min.", opts.getTimeout() * 1000 <= endTime - startTime);
        // Test that we didn't take forever (be forgiving).
        // Theoretically this test could fail very occasionally if the
        // OS task swaps or locks up for a second at the wrong moment.
        assertTrue("main: Timeout max.", opts.getTimeout() * 1000 * 2 > endTime - startTime);
        ...
        a = "1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n";
        b = "abcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\n";
        assertEquals("main: Simple line-mode.", new Diff(a, b, opts), new Diff(a, b, opts));

        opts.withChangeLines(true);

        a = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";
        b = "abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghij";
        assertEquals("main: Single line-mode.", new Diff(a, b, opts), new Diff(a, b, opts));
    ...
    private static Diff diff(Change... diffs) {
        return new Diff(diffList(diffs), defaults());
    }
}
